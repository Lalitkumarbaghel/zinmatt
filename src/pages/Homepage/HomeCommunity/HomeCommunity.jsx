            ...
            <div className='container'>
                <div className='row justify-content-center align-items-center'>
                    ...
                    <div className='col-md-6'>
                        ...
                        <h1 className="head_high">Zinmatt Community</h1>
                        <p>"At Zinmatt, we embody the philosophy of Lern, Earn & Grow. Committed to your success, we stand by you 24 hours a day. Our unwavering dedication, doubt support, and emphasis on practical skills pave the way for your journey to excellence. Together, let's build a future where learning knows no bounds, earning knows no limits, and growth is a constant companion."</p>
                        </div>
                    </div>
                </div>
            </div>
